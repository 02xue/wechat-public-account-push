export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxd5b6a27e22c35cd8",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "0e298c53cb75b7efa5f1987cdabd3bd8",
  ...
  USERS: [
    {
      ...
      customizedDateList: [
      // 在一起的日子
        {"keyword": "love_day", date: "2020-10-29"},
      ]
    },
    {
      name: "啊，是小袁",
  ...
  CALLBACK_TEMPLATE_ID: "A1QWHuiVahmhXVbc9GMz5EBWP8nqn3Lxb5XWI7C_GOA",
